...
export default function Home(props) {
    const {posts, persons} = usePage().props
    console.log(posts)
    console.log(persons)
    return (
        <>
            <div>
              ...
              <Nav/>
                ...
                <div className="list-section mt-10 p-20">
                    <div className="container">
                        <div className="row">
                    ...
                    <div className="container">
                        <div className="row clearfix">
                            ...
                            <div className="content-column col-lg-6">
                                <h3>
                                    <span className="orange-text">Deal</span> of
                                    the month
                                </h3>
                                <h4>Hikan Strwaberry</h4>
                                <div className="text">
                                    Quisquam minus maiores repudiandae nobis,
                                    minima saepe id, fugit ullam similique!
                            ...
                            <div className="col-lg-6 col-md-12">
                                <div className="abt-text">
                                    ...
                                    <p>
                                        ...
                                        sollicitudin neque et massa porttitor
                                        vestibulum ac vel nisi. Vestibulum
                                        placerat eget dolor sit amet posuere. In
                                        ut dolor aliquet, aliquet sapien sed,
                                        interdum velit. Nam eu molestie lorem.
                                    </p>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur
                                        adipisicing elit. Sapiente facilis illo
                                        repellat veritatis minus, et labore
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-latest-news">
                                    ...
                                    <div className="news-text-box">
                                        <h3>
                                            <a href="single-news.html">
                                                You will vainly look for fruit
                                                on it in autumn.
                                            </a>
                                        </h3>
                                        ...
                                        <p className="excerpt">
                                            Vivamus lacus enim, pulvinar vel
                                            nulla sed, scelerisque rhoncus nisi.
                                            Praesent vitae mattis nunc, egestas
                                            viverra eros.
                                        </p>
                                        <a
