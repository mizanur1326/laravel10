...
<head>
    ...
    <link href="{{asset('assets/vendors/fonts/circular-std/style.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('assets/libs/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('assets/vendors/fonts/fontawesome/css/fontawesome-all.css')}}">
    <link rel="stylesheet" href="{{asset('assets/vendors/vector-map/jqvmap.css')}}">
    <link rel="stylesheet" href="{{asset('assets/vendors/jvectormap/jquery-jvectormap-2.0.2.css')}}">
    <link rel="stylesheet" href="{{asset('assets/vendors/fonts/flag-icon-css/flag-icon.min.css')}}">
...
<body>
    ...
    <script src="{{asset('assets/vendors/charts/charts-bundle/chartjs.js')}}"></script>
   
    <!-- main js-->
    <script src="{{asset('asset/libs/js/main-js.js')}}"></script>
    <!-- jvactormap js-->
    <script src="{{asset('assets/vendors/jvectormap/jquery-jvectormap-2.0.2.min.js')}}"></script>
    <script src="{{asset('assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
    <!-- sparkline js-->
    <script src="{{asset('assets/vendors/charts/sparkline/jquery.sparkline.js')}}"></script>
    <script src="{{asset('assets/vendors/charts/sparkline/spark-js.js')}}"></script>
     <!-- dashboard sales js-->
    <script src="{{asset('asset/libs/js/dashboard-sales.js')}}"></script>
</body>
